      ...
      <div class="container">
        ...
        <div class="row center">
          <div class="col s12 m12 l12 xl12">
            <h3 class ="light"><b> Alterar Carro </b></h3>
              ...
              <input  type="hidden" name="id" value="<?php echo $dados['id']; ?>">
                ...
                <div class = "input-field col s12 m4">
                  <input type ="text" name="modelo_fab" id="modelo_fab" value="<?php echo$dados['modelo_fab']; ?>">
                ...
                <button type="submit" name="btn_alterar" class="btn azul-marinho">Alterar</button>
