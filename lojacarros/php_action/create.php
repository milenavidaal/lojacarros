...
if(isset($_POST['btn_adicionar'])) :
  ...
  $mod_fab = mysqli_escape_string($connect, $_POST['modelo_fab']);
  $cor = mysqli_escape_string($connect, $_POST['cor']);
  $placa = mysqli_escape_string($connect, $_POST['placa']);
  $valor = mysqli_escape_string($connect, $_POST['valor']);

  $sql = "INSERT INTO estoque(marca, modelo, descricao, modelo_fab, cor, placa, valor) 
  VALUES('$marca', '$modelo','$descricao','$modelo_fab', '$cor','$placa', '$valor')";
